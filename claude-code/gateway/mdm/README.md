...
```bash
sudo python3 -c "$(curl -fsSL https://raw.githubusercontent.com/websentry-ai/setup/refs/heads/main/claude-code/gateway/mdm/setup.py)" --url https://backend.getunbound.ai --api_key YOUR_ADMIN_API_KEY
```
